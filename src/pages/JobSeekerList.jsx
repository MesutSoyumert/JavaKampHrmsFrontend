      ...
      <Table celled>
        <Table.Header>
          <Table.Row>
            ...
            <Table.HeaderCell>
              İş Arayan TC Kimlik No Doğrulandı mı?
            </Table.HeaderCell>
            <Table.HeaderCell>
              İş Arayan TC Kimlik No Doğrulanma Tarihi
            </Table.HeaderCell>
            <Table.HeaderCell>
              İş Arayan E-posta Adresi Doğrulandı mı?
            </Table.HeaderCell>
            <Table.HeaderCell>
              İş Arayan TC E-posta Adresi Doğrulanma Tarihi
            </Table.HeaderCell>
